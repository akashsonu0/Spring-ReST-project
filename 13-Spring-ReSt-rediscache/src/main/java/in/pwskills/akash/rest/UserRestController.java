...
import in.pwskills.akash.service.UserService;
...
public class UserRestController {
	 ...
	 * INPUT  :	path variable -> id
	 * OUTPUT : String
	 * CACHING IS NEEDED AS IT IS "DELETE" OPERATION ON 1-OBJECT
	 */
	 ...
	 * INPUT  : User object
	 * OUTPUT : String
	 * CACHING IS NEEDED AS IT IS "UPDATE" OPERATION ON 1-OBJECT
	 */
